...
<Steps>
  ...
  <Step title="Sync repositories">
    Hacktron imports the repositories that the integration is allowed to see. If
    a repository is missing, update the provider installation first, then return
    to Hacktron and sync again.
  </Step>
