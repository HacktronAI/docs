...
<Note>
  **Include** and **Skip** can both be set for the same category: Skip takes priority within that category. Setting a filter for one category has no effect on the others.
</Note>
