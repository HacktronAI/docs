---
title: "Automations"
description: "Act on qualifying findings automatically: configure triggers, actions, and notifiers, and Hacktron takes it from there."
---

Automations act on findings for you. Configure which findings qualify, and when a matching finding is reported, Hacktron fires the automation:
its **actions** run against the finding, and its **notifiers** alert your team over Slack or email.

<Tip>
  **Autofix** is the first available action — it starts a
