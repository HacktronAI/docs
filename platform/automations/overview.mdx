...
<Tip>
  **Remediation** is the first available action. It starts a [remediation](/platform/automations/remediation) run that fixes the finding, and we'll expand automations with more actions over time.
</Tip>
...
![Run history](/images/automation-run-history.png)
