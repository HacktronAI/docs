...
<Steps>
  <Step title="Keep a balance">
    Your organization starts with zero automation credits. Buy credits from **Billing**, or turn on auto top-up to keep the balance above a threshold you set.
  </Step>
...
<Steps>
  <Step title="Open Billing">
    Go to **Billing** in the Hacktron dashboard and find your automation credit balance.
  </Step>
