...
description: "Understand how to buy Automation credits, how runs use them, and how auto top-up works."
---
...
<Steps>
  <Step title="Keep a balance">
    ...
    Organization owners can buy credits from **Billing** or turn on [auto top-up](#auto-top-up) to keep the balance above a threshold they set.
...
The Automation credits card on **Billing** shows the current balance, credits used in the billing period, auto top-up status, and a link to run history. Whitebox Scan Credits appear in a separate account and are never used for automation runs.
