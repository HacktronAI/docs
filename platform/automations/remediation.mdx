...
Remediation runs use [automation credits](/platform/automations/credits). You can start a run yourself from a finding, let it happen automatically through an [automation](/platform/automations/overview)'s Remediation action or your [repository configuration](/code-review/config#auto-remediate-findings).
