...
<AccordionGroup>
  ...
  <Accordion title="We want to skip the trial and start paid immediately.">
    On the Billing page, the Owner adds a payment method and chooses **Start paid plan** instead of **Start trial**. The subscription activates today; the billing period starts today.

    Caveat: starting the trial OR skipping straight to paid both permanently disable any future trial for this organization. There is no second trial.

    See [Trial & activation](/platform/billing/trial#the-trial-skip-path).
  </Accordion>
...
- **Trial-skip** — going from no-subscription straight to paid, bypassing the trial. The org's trial eligibility is permanently consumed once any trial path is started or skipped.
