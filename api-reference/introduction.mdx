...
Every endpoint page in this reference is generated from the public OpenAPI spec and ships with an interactive playground. Use the **Send** button on any endpoint to set your `X-Api-Key` and try requests against production with live request and response schemas.

## What you can do

<Columns cols={2}>
  <Card title="Run pentest scans" icon="shield-halved" href="/api-reference/scans/trigger-a-pentest-scan">
