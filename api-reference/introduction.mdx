...
<Columns cols={2}>
  <Card
    title="Run Whitebox Scans"
    icon="shield-halved"
    href="/api-reference/scans/create-scan"
  >
    Start Whitebox Scans against one or more repositories and track their
    status.
  </Card>
  <Card
    title="Estimate cost"
    icon="calculator"
    href="/api-reference/cost-estimations/create-cost-estimation"
  >
    Generate a cost estimation for a set of repositories before committing
    credits.
  </Card>
  <Card
  ...
  >
    List, filter, and inspect findings across scans, including their full triage
    context.
  </Card>
  <Card
    title="Triage findings"
    icon="check"
    href="/api-reference/findings/update-finding"
  >
    Update finding state, adjust severity, and add comments from your own
    systems.
  </Card>
</Columns>
...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="list"
    href="/api-reference/pagination-filtering"
  >
