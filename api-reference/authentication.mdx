...
<Tip>
  Every endpoint page in this reference has an interactive playground. Enter your `X-Api-Key` in the playground's authorization field and it persists across requests for that session.
</Tip>
