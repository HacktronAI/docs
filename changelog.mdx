...
<Update label="July 11, 2026" tags={["Whitebox","Code Review","Integrations","API"]}>
  ...
  **AI remediation**: For supported findings, you can now trigger an automated fix directly from a finding. Hacktron opens a pull request with the proposed change applied, so you go from alert to candidate fix without leaving your workflow. Automatic triggers are also available through automations.
