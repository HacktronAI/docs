...
{/* CHANGELOG:INSERT last-prod-sha=16bd6d1122e2b54cb2930420ad33c8d1f4f210ff - the changelog workflow inserts new <Update> blocks directly below this line. Do not remove this marker. */}

<Update label="August 3, 2026" tags={["Billing"]}>
  ## Your Automation and Whitebox credits are now separate

  **Separate credit accounts**: The billing page now shows Automation credits and Whitebox Scan Credits as two independent accounts, each with its own balance, usage for the period, and top-up settings. You can see exactly where credits are going and manage each account on its own.

  **[See billing and plans →](/platform/billing)** · **[Manage Automation credits →](/platform/automations/credits)**
</Update>
