...
<Update label="June 23, 2026" tags={["Context","Code Review","Whitebox","Integrations","MCP"]}>
  ...
  **[<u>Explore the Context page →</u>](/platform/context/overview)** · **[<u>Group repositories into an application →</u>](/platform/context/applications)** · **[<u>Learn how threat models work →</u>](/platform/context/threat-models)** · **[<u>Set a fail-on severity threshold →</u>](/code-review/config#fail-the-check-on-findings)** · **[<u>Read the API reference →</u>](/api-reference/findings/update-finding)**
</Update>
