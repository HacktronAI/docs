...
<Steps>
  <Step title="Connect a Git provider">
    Open **Integrations** and connect GitHub, GitHub Enterprise Server, GitLab, Azure DevOps, or Bitbucket.
    ...
    <Columns cols={2}>
      ...
      <Card
        title="Bitbucket"
        icon="bitbucket"
        href="/platform/repositories/bitbucket"
      >
        Connect Bitbucket Cloud through a repository administrator account.
      </Card>
    </Columns>
