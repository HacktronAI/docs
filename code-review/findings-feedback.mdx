...
<img
  src="/images/public_repository_redacted_findings.png"
  alt="Public repository pull request comment with outside-diff finding details hidden"
/>
